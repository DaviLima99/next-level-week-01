...
const Points = () => {
    ...
    function handleSelecItems(id: number) {
            ...
            <View style={styles.itemsContainer}>
                <ScrollView 
                    ...
                    contentContainerStyle={{paddingHorizontal: 20}}>
                        {items.map(item => (
                             <TouchableOpacity key={String(item.id)} style={[styles.item, selectedItems.includes(item.id) ? styles.selectedItem : {}]} onPress={() => handleSelecItems(item.id)} activeOpacity={0.6}>
